...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <button class="btn btn-outline-default"><a href="logout.php" style="color:black"> LOGOUT </a></button>;

      <button class="btn btn-outline-default"><a href="login.php" style="color:black">LOGIN </a></button>
